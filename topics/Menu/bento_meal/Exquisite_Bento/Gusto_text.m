...
: Gusto_intro
  ...
  "Save Le Gusto Bento" yesButton ctx{ save }
  "Remove item" noButton ctx{ remove }
  "Back" backButton ctx{ back }
  
  Gusto_pic_url menu_pic ctx{ Gusto_p }
  q{
        <h2 style="text-align:center">Le Gusto Bento</h2>
        <center>#{Gusto_p}</center>
        <p style="text-align:center; margin-top:10px">$14.00/Pax (Min 20 Pax)</p> 
        <p style="text-align:center">(W.GST $14.98)</p>
        <p style="text-align:center; margin-top:10px">
          View course details & Order <br>
          <a href="https://lerainbow.com.sg/product/le-gusto-bento-14-pax-min-15pax/">
            Here
          </a>
        </p>

...
: Romance_intro
  ...
  "Save Le Romance Wedding Buffet" yesButton ctx{ save }
  "Remove item" noButton ctx{ remove }
  "Back" backButton ctx{ back }
  
  Romance_pic_url menu_pic ctx{ Romance_p }
  
  q{
        <h2 style="text-align:center">Le Romance Wedding Buffet</h2>
        <center>#{Romance_p}</center>
        <p style="text-align:center; margin-top:10px">$18.00/Pax (Min 50 Pax)</p> 
        <p style="text-align:center">(W.GST $19.26)</p>
        <p style="text-align:center; margin-top:10px">
          View course details & Order <br>
          <a href="https://lerainbow.com.sg/product/le-romance-wedding-buffet-18-pax-min-50pax/">
            Here
          </a>
        </p>

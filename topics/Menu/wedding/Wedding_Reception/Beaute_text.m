...
: Beaute_intro
  ...
  "Save Le Beaute Wedding Buffet" yesButton ctx{ save }
  "Remove item" noButton ctx{ remove }
  "Back" backButton ctx{ back }
  
  Beaute_pic_url menu_pic ctx{ Beaute_p }
  
  q{
        <h2 style="text-align:center">Le Beaute Wedding Buffet</h2>
        <center>#{Beaute_p}</center>
        <p style="text-align:center; margin-top:10px">$38.00/Pax (Min 60 Pax)</p> 
        <p style="text-align:center">(W.GST $40.66)</p>
        <p style="text-align:center; margin-top:10px">
          View course details & Order <br>
          <a href="https://lerainbow.com.sg/product/le-beaute-wedding-buffet-38-pax-min-60pax/">
            Here
          </a>
        </p>
